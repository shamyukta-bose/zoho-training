...
public class rail {
    ...
    static String place[] = { "Chennai", "Bangalore", "Vijayawada", "Visakhapatinum", "Bhuvaneshwar", "Balasur", "Howrah" };
        ...
        while (true) {
            if (Admin_Attempt >= 0) {
                ...
                if (id.equals(Admin_Id) && pass.equals(Admin_Password)) {
                    ...
                    Clr_scr();
                    Admin_Attempt -= 1;
                    System.out.println("Id and Password mismatch Please try again ! You have only " + Admin_Attempt
                            + " Attempt's");
                }
            } else {
                Clr_scr();
    ...
    static void User_Register() {
        while (true) {
            System.out.print("Welcome to user Registration \nEnter your name : ");
            String name = sc.next();
            sc.nextLine();
            System.out.print("Enter your Password : ");
            String pass = sc.next();
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Welcome To Northern Railway booking!");
